...
#    "/data/xiaochen/FedMFM/ckpt/ours_fedavg_multi___/5/pytorch_model.pt /data/xiaochen/FedMFM/preprocessed_jsons/ecg_test.json"
    ...
    # "/data/xiaochen/FedMFM/ckpt/ours_fedavg_multi___/5/pytorch_model.pt /data/xiaochen/FedMFM/preprocessed_jsons/ecgqa_few_shot_test.json"
    # "/data/xiaochen/FedMFM/ckpt/ours_no_fl/0/pytorch_model.pt /data/xiaochen/FedMFM/preprocessed_jsons/chexpert_few_shot_test.json"
    # "/data/xiaochen/FedMFM/ckpt/ours_no_modality__final/pytorch_model_ep7.pt /data/xiaochen/FedMFM/preprocessed_jsons/chexpert_few_shot_test.json"
    # "/data/xiaochen/FedMFM/ckpt/ours_no_task__/5/pytorch_model.pt /data/xiaochen/FedMFM/preprocessed_jsons/ate_test.json"
